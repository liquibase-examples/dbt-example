...
-- Also grant the specific roles that will be granted to, which is required in Snowflake
GRANT MANAGE GRANTS ON ACCOUNT TO ROLE DATABASE_ADMIN_ROLE;
GRANT ROLE LIQUIBASE_ROLE TO ROLE DATABASE_ADMIN_ROLE;
GRANT ROLE DBT_ROLE TO ROLE DATABASE_ADMIN_ROLE;
